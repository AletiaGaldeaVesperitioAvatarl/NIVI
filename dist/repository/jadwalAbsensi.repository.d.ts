import { PrismaClient, JadwalAbsensi, Hari } from "../../dist/generated/index.js";
export declare class JadwalAbsensiRepository {
    private prisma;
    constructor(prisma: PrismaClient);
    countByKelas(kelasId: number): import("../../dist/generated/index.js").Prisma.PrismaPromise<number>;
    ...
    findBentrok(kelasId: number, tanggal: Date, jamMulai: string, jamSelesai: string): import("../../dist/generated/index.js").Prisma.Prisma__JadwalAbsensiClient<{
        id: number;
        kelasId: number;
        tanggal: Date;
        createdAt: Date;
    ...
    createBulk: (kelasId: number, jamMulai: string, jamSelesai: string, tanggalMulai: Date, tanggalSelesai: Date) => Promise<import("../../dist/generated/index.js").Prisma.BatchPayload>;
    ...
    findByTanggal(kelasId: number, tanggal: Date): import("../../dist/generated/index.js").Prisma.Prisma__JadwalAbsensiClient<{
        id: number;
        kelasId: number;
        tanggal: Date;
        createdAt: Date;
    ...
    findByHari(kelasId: number, hari: Hari): import("../../dist/generated/index.js").Prisma.Prisma__JadwalAbsensiClient<{
        id: number;
        kelasId: number;
        tanggal: Date;
        createdAt: Date;
    ...
    countAbsensiByTanggalDanKelas(kelasId: number, tanggal: Date): import("../../dist/generated/index.js").Prisma.PrismaPromise<number>;
