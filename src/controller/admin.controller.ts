...
export class AdminController {
  ...
  // CREATE SANTRI
  createSantriByAdmin = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // CREATE PENGAJAR
  createPengajarByAdmin = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  activateWithPassword = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  // PENGAJAR KELAS
  assignPengajar = async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  removePengajar = async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { kelasId, pengajarId } = req.body;
  ...
  getPengajarByKelas = async (req: Request, res: Response, next: NextFunction) => {
    try {
